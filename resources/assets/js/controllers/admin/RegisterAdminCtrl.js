(function(){
  ...
  angular.module('heroesDigitalesApp')
    .controller('RegisterAdminCtrl', ['User', 'Auth', 'City', 'Shirt', 'Genre', 'Register', 'LxNotificationService', RegisterAdminCtrl]);
  function RegisterAdminCtrl(User, Auth, City, Shirt, Genre, Register, LxNotificationService){
    var vm = this;
    // Methods
    ...
    function setRegProps(type){
      if(type == 'student'){
        ...
        vm.dataRegister.type = 'student';
      }else if(type == 'mentor'){
        vm.typeParams.title = 'Mentor';
        vm.dataRegister.type = 'mentor';
      }else if(type == 'judge'){
        vm.typeParams.title = 'Juez';
        vm.dataRegister.type = 'judge';
      }else if(type == 'expert'){
        vm.typeParams.title = 'Experto';
        vm.dataRegister.type = 'expert';
      }
      return;
    };
    /**
    ...
    function sendRegistration(){
      console.log(vm.dataRegister.typeReg);
      ...
      Register.register(vm.dataRegister).then(function(data){
        if(data.success){
          LxNotificationService.success('El registro fue llenado con éxito');
