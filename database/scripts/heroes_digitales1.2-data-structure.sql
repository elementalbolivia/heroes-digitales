...
--
-- Host: localhost
-- Generation Time: Oct 02, 2017 at 06:51 PM
...
--
CREATE DATABASE IF NOT EXISTS `heroes_digitales` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
--
-- Table structure for table `confirmacion_email`
--
...
--
-- Table structure for table `datos_profesionales`
--
...
CREATE TABLE `equipo` (
  ...
  `modelo_negocio_archivo` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `estudiante_mentor_tiene_equipo`
--

CREATE TABLE `estudiante_mentor_tiene_equipo` (
  `id` int(10) NOT NULL,
  `equipo_id` int(10) NOT NULL,
  `mentor_id` int(10) DEFAULT NULL,
  `estudiante_id` int(10) DEFAULT NULL,
  `lider_equipo` tinyint(1) DEFAULT NULL,
...
--
-- Table structure for table `experticia`
--
...
--
-- Table structure for table `invitaciones_equipo`
--
...
--
-- Table structure for table `mentor_tiene_habilidad`
--

CREATE TABLE `mentor_tiene_habilidad` (
  `id` int(10) NOT NULL,
...
CREATE TABLE `proyecto` (
  ...
  `codigo_fuente_archivo` varchar(255) DEFAULT NULL,
  `plataforma` varchar(45) DEFAULT NULL,
  `fecha_creacion` datetime DEFAULT NULL,
  `fecha_actualizacion` datetime DEFAULT NULL,
  `categoria_id` int(10) NOT NULL,
  `descripcion` varchar(500) NOT NULL,
  `proyecto_aprobado` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `proyecto` (`id`, `equipo_id`, `nombre_proyecto`, `codigo_fuente_archivo`, `plataforma`, `fecha_creacion`, `fecha_actualizacion`, `categoria_id`, `descripcion`, `proyecto_aprobado`) VALUES
(1, 7, 'PachaCUTI', NULL, NULL, '2017-09-03 18:23:13', '2017-09-04 23:36:05', 1, 'La app dara informacion sobre animales en peligro de extincion', 0),
(2, 8, '', NULL, NULL, '2017-09-04 09:38:51', '2017-09-04 09:38:51', 1, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni modi omnis, deserunt iure quod saepe qui fugiat, inventore animi earum suscipit mollitia amet esse quibusdam excepturi maiores impedit vel repudiandae.', 0),
(3, 9, '', NULL, NULL, '2017-09-04 11:37:47', '2017-09-04 11:37:47', 1, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste provident excepturi aliquam ducimus consectetur quaerat debitis ut commodi. Culpa nihil rem eveniet inventore. Mollitia rem corrupti delectus facere, error necessitatibus.', 0),
(4, 12, 'primero soy yo', NULL, NULL, '2017-09-16 16:33:06', '2017-09-16 16:33:06', 1, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis nemo sequi ex modi quasi culpa expedita non corporis, vel provident nostrum, cumque ducimus ea. Officia adipisci laborum eaque quasi tempore.', 0),
(5, 13, 'Aplicacion para llamadas de emergencia', NULL, NULL, '2017-09-17 23:21:21', '2017-09-17 23:21:21', 1, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae officiis delectus illo, enim maxime corrupti. Suscipit eum alias omnis, voluptates, maiores cumque minus consequuntur aperiam ratione, qui minima voluptatum, laboriosam!', 0),
(6, 14, 'Aplicacion para detectar lugares protegidos', NULL, NULL, '2017-09-17 23:45:37', '2017-09-17 23:45:37', 1, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor est, dolores! Beatae sit suscipit accusantium, voluptatem totam rem veritatis voluptatum laborum nam, porro consequuntur repellat magni veniam dolorem. Maiores, eum.', 0),
(7, 15, 'Earth', NULL, NULL, '2017-09-18 08:26:11', '2017-09-18 08:26:11', 1, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vitae perferendis modi ipsum molestiae, doloribus soluta tenetur dolore labore quibusdam nemo distinctio quos, ducimus alias ipsam inventore maxime accusamus consequatur fugiat.', 0),
(8, 16, 'Trafico', NULL, NULL, '2017-09-18 10:11:52', '2017-09-18 10:11:52', 1, 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate non deleniti officia at minus quidem beatae, alias quis, delectus perferendis saepe molestiae eos dolorum ullam neque, aut sit explicabo. Similique!', 0);

-- --------------------------------------------------------

--
-- Table structure for table `reestablecer_password`
--
...
CREATE TABLE `usuario` (
  ...
  `terminos_uso` tinyint(1) DEFAULT '0',
...
--
-- Table structure for table `video_proyecto`
--

CREATE TABLE `video_proyecto` (
  `id` int(10) NOT NULL,
  `proyecto_id` int(10) NOT NULL,
  `nombre_archivo` varchar(255) DEFAULT NULL,
  `es_pitch` tinyint(1) DEFAULT '0',
...
ALTER TABLE `admin`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_admin_usuario1_idx` (`usuario_id`);
...
ALTER TABLE `biografia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_biografia_usuario1_idx` (`usuario_id`);
...
--
-- Indexes for table `confirmacion_email`
--
ALTER TABLE `confirmacion_email`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_confirmacion_email_usuario1_idx` (`usuario_id`);

--
-- Indexes for table `datos_profesionales`
--
ALTER TABLE `datos_profesionales`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_datos_profesionales_usuario1_idx` (`usuario_id`),
...
ALTER TABLE `equipo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_equipo_ciudad1_idx` (`ciudad_id`),
  ADD KEY `fk_equipo_division1_idx` (`division_id`);
...
ALTER TABLE `estudiante`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_estudiante_usuario1_idx` (`usuario_id`),
  ADD KEY `fk_estudiante_colegio1_idx` (`colegio_id`);

--
-- Indexes for table `estudiante_mentor_tiene_equipo`
--
ALTER TABLE `estudiante_mentor_tiene_equipo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_estudiante_mentor_tiene_equipo_equipo1_idx` (`equipo_id`),
  ADD KEY `fk_estudiante_mentor_tiene_equipo_mentor1_idx` (`mentor_id`),
  ADD KEY `fk_estudiante_mentor_tiene_equipo_estudiante1_idx` (`estudiante_id`);

--
-- Indexes for table `experticia`
--
ALTER TABLE `experticia`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `experto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_experto_usuario1_idx` (`usuario_id`);
...
ALTER TABLE `imagen_proyecto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_imagen_equipo_proyecto1_idx` (`proyecto_id`);

--
-- Indexes for table `invitaciones_equipo`
--
...
ALTER TABLE `juez`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_juez_usuario1_idx` (`usuario_id`);
...
ALTER TABLE `mentor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_mentor_usuario1_idx` (`usuario_id`);

--
-- Indexes for table `mentor_tiene_habilidad`
--
ALTER TABLE `mentor_tiene_habilidad`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_mentor_tiene_habilidad_experticia1_idx` (`experticia_id`),
  ADD KEY `fk_mentor_tiene_habilidad_habilidad1_idx` (`habilidad_id`),
  ADD KEY `fk_mentor_tiene_habilidad_mentor1_idx` (`mentor_id`);
...
ALTER TABLE `proyecto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_proyecto_equipo1_idx` (`equipo_id`),
  ADD KEY `fk_proyecto_categoria1_idx` (`categoria_id`);

--
-- Indexes for table `reestablecer_password`
--
ALTER TABLE `reestablecer_password`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_reestablecer_password_usuario1_idx` (`usuario_id`);
...
ALTER TABLE `responsable`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_responsable_estudiante1_idx` (`estudiante_id`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `fk_usuario_zona1_idx` (`zona_id`),
...
ALTER TABLE `usuario_tiene_rol`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_usuario_tiene_rol_usuario1_idx` (`usuario_id`),
  ADD KEY `fk_usuario_tiene_rol_rol1_idx` (`rol_id`);

--
-- Indexes for table `video_proyecto`
--
ALTER TABLE `video_proyecto`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_video_proyecto_proyecto1_idx` (`proyecto_id`);
...
ALTER TABLE `colegio`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `confirmacion_email`
--
ALTER TABLE `confirmacion_email`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT for table `datos_profesionales`
--
ALTER TABLE `datos_profesionales`
...
ALTER TABLE `estudiante`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `estudiante_mentor_tiene_equipo`
--
ALTER TABLE `estudiante_mentor_tiene_equipo`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `experticia`
--
ALTER TABLE `experticia`
...
ALTER TABLE `imagen_proyecto`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `invitaciones_equipo`
--
ALTER TABLE `invitaciones_equipo`
...
--
-- AUTO_INCREMENT for table `mentor_tiene_habilidad`
--
ALTER TABLE `mentor_tiene_habilidad`
...
--
-- AUTO_INCREMENT for table `reestablecer_password`
--
ALTER TABLE `reestablecer_password`
...
--
-- AUTO_INCREMENT for table `usuario_tiene_rol`
--
ALTER TABLE `usuario_tiene_rol`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
-- AUTO_INCREMENT for table `video_proyecto`
--
ALTER TABLE `video_proyecto`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `admin`
  ADD CONSTRAINT `fk_admin_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `biografia`
--
ALTER TABLE `biografia`
  ADD CONSTRAINT `fk_biografia_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `confirmacion_email`
--
ALTER TABLE `confirmacion_email`
  ADD CONSTRAINT `fk_confirmacion_email_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `datos_profesionales`
--
ALTER TABLE `datos_profesionales`
  ADD CONSTRAINT `fk_datos_profesionales_profesion_id` FOREIGN KEY (`profesion_id`) REFERENCES `profesion` (`id`),
  ADD CONSTRAINT `fk_datos_profesionales_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `equipo`
--
ALTER TABLE `equipo`
  ADD CONSTRAINT `fk_equipo_ciudad1` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_equipo_division1` FOREIGN KEY (`division_id`) REFERENCES `division` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `estudiante`
--
ALTER TABLE `estudiante`
  ADD CONSTRAINT `fk_estudiante_colegio1` FOREIGN KEY (`colegio_id`) REFERENCES `colegio` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estudiante_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `estudiante_mentor_tiene_equipo`
--
ALTER TABLE `estudiante_mentor_tiene_equipo`
  ADD CONSTRAINT `fk_estudiante_mentor_tiene_equipo_equipo1` FOREIGN KEY (`equipo_id`) REFERENCES `equipo` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estudiante_mentor_tiene_equipo_estudiante1` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiante` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estudiante_mentor_tiene_equipo_mentor1` FOREIGN KEY (`mentor_id`) REFERENCES `mentor` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `experto`
--
ALTER TABLE `experto`
  ADD CONSTRAINT `fk_experto_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `imagen`
--
ALTER TABLE `imagen`
  ADD CONSTRAINT `fk_imagen_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `imagen_proyecto`
--
ALTER TABLE `imagen_proyecto`
  ADD CONSTRAINT `fk_imagen_equipo_proyecto1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyecto` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `invitaciones_equipo`
--
ALTER TABLE `invitaciones_equipo`
  ADD CONSTRAINT `fk_equipo_id` FOREIGN KEY (`equipo_id`) REFERENCES `equipo` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_estudiante_id` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiante` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mentor_id` FOREIGN KEY (`mentor_id`) REFERENCES `mentor` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `juez`
--
ALTER TABLE `juez`
  ADD CONSTRAINT `fk_juez_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `mentor`
--
ALTER TABLE `mentor`
  ADD CONSTRAINT `fk_mentor_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `mentor_tiene_habilidad`
--
ALTER TABLE `mentor_tiene_habilidad`
  ADD CONSTRAINT `fk_mentor_tiene_habilidad_experticia1` FOREIGN KEY (`experticia_id`) REFERENCES `experticia` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mentor_tiene_habilidad_habilidad1` FOREIGN KEY (`habilidad_id`) REFERENCES `habilidad` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_mentor_tiene_habilidad_mentor1` FOREIGN KEY (`mentor_id`) REFERENCES `mentor` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `proyecto`
--
ALTER TABLE `proyecto`
  ADD CONSTRAINT `fk_proyecto_categoria1` FOREIGN KEY (`categoria_id`) REFERENCES `categoria` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_proyecto_equipo1` FOREIGN KEY (`equipo_id`) REFERENCES `equipo` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `reestablecer_password`
--
ALTER TABLE `reestablecer_password`
  ADD CONSTRAINT `fk_reestablecer_password_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `responsable`
--
ALTER TABLE `responsable`
  ADD CONSTRAINT `fk_responsable_estudiante1` FOREIGN KEY (`estudiante_id`) REFERENCES `estudiante` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `fk_usuario_ciudad1` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usuario_genero1` FOREIGN KEY (`genero_id`) REFERENCES `genero` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usuario_zona1` FOREIGN KEY (`zona_id`) REFERENCES `zona` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `usuario_tiene_rol`
--
ALTER TABLE `usuario_tiene_rol`
  ADD CONSTRAINT `fk_usuario_tiene_rol_rol1` FOREIGN KEY (`rol_id`) REFERENCES `rol` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usuario_tiene_rol_usuario1` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Constraints for table `video_proyecto`
--
ALTER TABLE `video_proyecto`
  ADD CONSTRAINT `fk_video_proyecto_proyecto1` FOREIGN KEY (`proyecto_id`) REFERENCES `proyecto` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
