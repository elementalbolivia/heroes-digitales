(function(){
	...
	angular.module('heroesDigitalesApp')
		.controller('CheckpointAdminCtrl', CheckpointAdminCtrl);
	CheckpointAdminCtrl.$inyect = ['User', 'Auth', 'Checkpoint', 'LxNotificationService', 'LxDatePickerService', '$state', '$stateParams'];
