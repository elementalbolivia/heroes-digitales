...
angular.module('heroesDigitalesApp', ['ui.router', 'ngAnimate', 'ngTouch', 'ngFileUpload', 'angular-locker', 'lumx']).constant('PUBLIC_URL', 'http://heroesdigitales.org/api/v1/').constant('AUTH_URL', 'http://heroesdigitales.org/api/v1/auth/').config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider) {
	$stateProvider
	/**
  *######### PUBLIC STATES ##########
  */
